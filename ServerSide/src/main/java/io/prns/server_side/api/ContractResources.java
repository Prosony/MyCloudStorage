package io.prns.server_side.api;
...
import io.prns.server_side.models.ContractLoginRequest;
import io.prns.server_side.services.ContractService;
...
public class ContractResources {
    ...
    public Map<String, Object> createAccount(@Valid ContractRegistrationRequest model,
        ...
        long status = service.createContract(model);
